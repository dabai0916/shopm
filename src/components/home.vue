    ...
    <el-container>
      <el-aside width="200px" class="aside">
        <el-menu 
          ...
          <el-submenu index="1">
            <template slot="title">
              <i class="el-icon-location-outline"></i>用户管理
            </template>
            <el-menu-item-group>
          ...
          <el-submenu index="2">
            <template slot="title">
              <i class="el-icon-location-outline"></i>权限管理
            </template>
            <el-menu-item-group>
          ...
          <el-submenu index="3">
            <template slot="title">
              <i class="el-icon-location-outline"></i>商品管理
            </template>
            <el-menu-item-group>
          ...
          <el-submenu index="4">
            <template slot="title">
              <i class="el-icon-location-outline"></i>订单管理
            </template>
            <el-menu-item-group>
          ...
          <el-submenu index="5">
            <template slot="title">
              <i class="el-icon-location-outline"></i>数据统计
            </template>
            <el-menu-item-group>
